 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Q(r){return j({...r,state:!0,attribute:!1})}const X=H`
  :host {
    all: initial;
...
`;var Bt=Object.getOwnPropertyDescriptor,Dt=(r,t,e,s)=>{for(var i=s>1?void 0:s?Bt(t,e):t,o=r.length-1,n;o>=0;o--)(n=r[o])&&(i=n(i)||i);return i};let Y=class extends A{render(){return R`
      <div class="filter">
        <button @click=${this._onClick}>필터</button>
      </div>
    `}_onClick(){this.dispatchEvent(new CustomEvent("filter-click",{bubbles:!0,composed:!1}))}};Y.styles=[X,H`
      .filter {
        width: 100%;
        padding: 20px 15px;
    ...
    `],Y=Dt([G("option-filter-button")],Y);var jt=Object.defineProperty,zt=Object.getOwnPropertyDescriptor,C=(r,t,e,s)=>{for(var i=s>1?void 0:s?zt(t,e):t,o=r.length-1,n;o>=0;o--)(n=r[o])&&(i=(s?n(t,e,i):n(i))||i);return s&&i&&jt(t,e,i),i};p.ReviewInCatalog=class extends A{constructor(){super(),this.goodsNo="",this.isVisible="on",this.reviews=[],this.pageSize=5,this.pageNumber=0,this.handleFilterClick=t=>{console.log("filter!"),this.pageNumber++,this.fetchReviewData()}}fetchReviewData(){fetch(`https://mapi-dev.oliveyoung.co.kr/review/api/v1/reviews/${this.goodsNo}/public?pageNumber=${this.pageNumber}&pageSize=${this.pageSize}`).then(t=>t.json()).then(t=>{t&&Array.isArray(t.data)?(this.reviews=t.data.map(e=>({...e,likes:typeof e.likes=="number"?e.likes:0})),this.requestUpdate()):console.error("error:",t)}).catch(t=>{console.error("error:",t)})}connectedCallback(){super.connectedCallback(),this.fetchReviewData()}handleClick(){this.pageNumber++,this.fetchReviewData()}handleLikeClick(t){const e=[...this.reviews];e[t]={...e[t],likes:(e[t].likes||0)+1},this.reviews=e,this.requestUpdate()}firstUpdated(){this.addEventListener("filter-click",this.handleFilterClick)}updated(t){var e;(e=super.updated)==null||e.call(this,t),t.has("goodsNo")&&(console.log("update: goodsNo"),this.fetchReviewData()),t.has("isVisible")&&this.requestUpdate()}render(){return this.isVisible==="off"?null:R`
      <slot></slot>
    ...
    `],C([j({type:String})],p.ReviewInCatalog.prototype,"goodsNo",2),C([j({type:String})],p.ReviewInCatalog.prototype,"isVisible",2),C([Q()],p.ReviewInCatalog.prototype,"reviews",2),C([Q()],p.ReviewInCatalog.prototype,"pageSize",2),C([Q()],p.ReviewInCatalog.prototype,"pageNumber",2),p.ReviewInCatalog=C([G("review-in-catalog")],p.ReviewInCatalog);var Lt=Object.defineProperty,Vt=Object.getOwnPropertyDescriptor,ft=(r,t,e,s)=>{for(var i=s>1?void 0:s?Vt(t,e):t,o=r.length-1,n;o>=0;o--)(n=r[o])&&(i=(s?n(t,e,i):n(i))||i);return s&&i&&Lt(t,e,i),i};return p.BlackBoxItem=class extends A{constructor(){super(...arguments),this._onBlackBoxClick=()=>{this.dispatchEvent(new CustomEvent("blackbox-click",{bubbles:!0,composed:!0}))}}render(){return R`
    ...
    `],ft([j({type:Object})],p.BlackBoxItem.prototype,"testObj",2),p.BlackBoxItem=ft([G("black-box-item")],p.BlackBoxItem),Object.defineProperty(p,Symbol.toStringTag,{value:"Module"}),p}({});
