import{f as k,u as $,i as g,a as y,x as d}from"./iframe-CtDDgSud.js";/**
 * @license
...
`;var D=Object.getOwnPropertyDescriptor,O=(e,t,s,o)=>{for(var i=o>1?void 0:o?D(t,s):t,r=e.length-1,n;r>=0;r--)(n=e[r])&&(i=n(i)||i);return i};let h=class extends y{render(){return d`
      <div class="filter">
        <button @click=${this._onClick}>필터</button>
      </div>
    `}_onClick(){this.dispatchEvent(new CustomEvent("filter-click",{bubbles:!0,composed:!1}))}};h.styles=[_,g`
      .filter {
        width: 100%;
        padding: 20px 15px;
    ...
    `];c([v({type:String})],a.prototype,"goodsNo",2);c([v({type:String})],a.prototype,"isVisible",2);c([b()],a.prototype,"reviews",2);c([b()],a.prototype,"pageSize",2);c([b()],a.prototype,"pageNumber",2);a=c([x("review-in-catalog")],a);const S={title:"Web Components/review-in-catalog",component:"review-in-catalog",tags:["autodocs"],parameters:{docs:{canvas:{sourceState:"shown"}},layout:"fullscreen"},argTypes:{goodsNo:{control:"text",description:"상품 번호",type:{name:"string",required:!0}},isVisible:{control:"radio",options:["on","off"],description:"컴포넌트 표시 여부",table:{type:{summary:"'on' | 'off'"}},defaultValue:{summary:"on"}}}},p={args:{goodsNo:"A000000113670",isVisible:"on"},render:({goodsNo:e,isVisible:t})=>d` <review-in-catalog goodsNo=${e} isVisible=${t}></review-in-catalog> `};var f,m,w;p.parameters={...p.parameters,docs:{...(f=p.parameters)==null?void 0:f.docs,source:{originalSource:`{
  args: {
...
}`,...(w=(m=p.parameters)==null?void 0:m.docs)==null?void 0:w.source}}};const j=["Default"];export{p as Default,j as __namedExportsOrder,S as default};
